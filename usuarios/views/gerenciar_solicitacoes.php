...
try {
    ...
    $condicoes = ['s.usuario_id' => $usuarioId];

    if ($statusFiltro) {
        $condicoes['s.status'] = $statusFiltro;
    }
            ...
            <div class="d-flex gap-2 mt-3 mt-md-0">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="filtroDropdown">
                        <li><a class="dropdown-item" href="<?php echo RAIZ_PROJETO; ?>usuarios/views/gerenciar_solicitacoes.php?status=pendente">Pendentes</a></li>
                        <li><a class="dropdown-item" href="<?php echo RAIZ_PROJETO; ?>usuarios/views/gerenciar_solicitacoes.php?status=marcado">Marcados</a></li>
