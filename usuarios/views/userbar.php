    ...
    <div class="body">
        ...
        <div class="links-userbar">
            <div class="icon">
                ...
                <a href="<?php echo RAIZ_PROJETO; ?>auth/logout.php"><i class="fa-solid fa-arrow-right-from-bracket" id="icon1"></i>Sair<i class="fa-solid fa-arrow-right" id="icon2"></i></a>
                <a href="#"><i class="fa-solid fa-trash" id="icon1"></i><strong><span class="deleta">Deletar conta</span></strong><i class="fa-solid fa-arrow-right" id="icon2"></i></a>
            </div>
        </div>
    </div>
    <div class="footer">
